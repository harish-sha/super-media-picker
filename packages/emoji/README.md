...
The `@company/media-emoji/compact` export contains the generated default-reaction subset and the same variant resolver. It keeps compact React entry points small without duplicating or synthesizing Unicode skin-tone sequences.
